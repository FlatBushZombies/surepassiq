...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(
        "Check your email to confirm your account. After confirmation, you can log in."
      );
    } finally {
      setBusy(false);
    }
      ...
      <div className="relative hidden flex-1 lg:block">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
          ...
          <p className="max-w-md text-lg text-primary-foreground/80">
            Practical courses from one trusted institution. Start your journey on Surepass IQ today.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <p className="mb-8 text-muted-foreground">
            Join Surepass IQ and start learning on your schedule
          </p>
          ...
          {success && (
            <p className="mb-4 rounded-lg border border-primary/40 bg-primary/10 px-3 py-2 text-sm text-foreground">
              {success}
            </p>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" size="lg" className="w-full" disabled={!acceptTerms || busy}>
